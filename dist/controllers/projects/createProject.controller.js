...
const createProject_service_1 = require("../../services/projects/createProject.service");
...
const createProjectController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const project = yield (0, createProject_service_1.createProjectService)(req.body);
...
//# sourceMappingURL=createProject.controller.js.map